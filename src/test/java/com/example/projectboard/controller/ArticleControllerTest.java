...
import com.example.projectboard.domain.contant.FormStatus;
...
class ArticleControllerTest {
    ...
    @DisplayName("[view][GET] 게시글 리스트 (게시판) 페이지 - 페이징, 정렬 기능 추가")
    @Test
    public void givenNothing_whenRequestingArticlesView_thenReturnsArticlesViewPage() throws Exception {
        // Given
    ...
    @Test
    public void givenHashtag_whenRequestingArticleSearchView_thenReturnsArticleView() throws Exception {
        // Given
        String hashtag = "#java";
        List<String> hashtags = List.of("#java", "#spring", "#boot");
    ...
    @Test
    void givenNothing_whenReqeusting_thenReturnsNewArticlePage() throws Exception {
        // Given
    ...
    // 테스트용 가상 계정 생성
    @WithUserDetails(value = "gyumipark", setupBefore = TestExecutionEvent.TEST_EXECUTION, userDetailsServiceBeanName = "userDetailsService")
