...
class ArticleCommentControllerTest {
    ...
    @WithUserDetails(value = "gyumipark", setupBefore = TestExecutionEvent.TEST_EXECUTION)
    @DisplayName("[view][POST] 댓글 등록 - 정상 호출")
    @Test
    void givenArticleCommentInfo_whenReqeusting_thenReturnsNewArticleComment() throws Exception {
        // Given
        long articleId = 1L;
    ...
    @Test
    void givenArticleCommentIdToDelete_whenReqeusting_thenDeletesArticleComment() throws Exception {
        // Given
        long articleId = 1L;
